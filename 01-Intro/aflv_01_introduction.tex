...
\begin{frame}{How?}
    ...
    \bi
        ...
        \item Introduce new algorithms and data structures
        \bi
		  \item Have you heard about \texttt{map}, \texttt{set}, \texttt{priority\_queue} or \texttt{dequeue}?
		  \item What about Fenwick-Trees, Union Finds, Suffix Arras?
...
\begin{frame}{Technical Matters -- Tutorial}
		\bi
			...
			\bi
				...
				\item easy - 3 points ($\approx 2$ per week)
				\item medium - 4 points ($\approx 2$ per week)
				\item hard - 5 points ($\approx 2$ per week)
...
\begin{frame}{Technical Matters -- Problems}
	\bi
		\item The GCPC will take place on \\
				Saturday, July 1\textsuperscript{st}, 11:00-16:00.
		...
		\ei
		\vspace{20pt}
		\item On June, 22\textsuperscript{th}, we will do a rehersal instead of a regular tutorial
		\bi
			\item 16:00 - 19:00, later submissions will not be allowed
			\item 6 problems and points as usual (but easier problems)
...
\begin{frame}[fragile]{Templates}
  \bi
	...
	\item<2-> Templates are a way to abstract parameter types
