...
\begin{frame}{Technical Matters}
		\begin{tabular}{l l}
			...
			Changes  & no lecture on 28.6., 12.7., and 19.7.\\
					& additional lectures: 23.4. and 4.6.\\
					& 10.5. moved to 7.5.\\
					& 31.5. moved to 28.5.\\
					& (all Monday, O27/429)\\
			\\
			...
			Instructor & Gregor Behnke (gregor.behnke@uni-ulm.de)\\
				ECTS & 6 (Bachelor CS, MI, and SE, Schwerpunkt)\\
			Mark & No exam\\
				 & Marks will be determined according to \\
				 & individual performance in the tutorial.\\
				 Moodle & \url{moodle.uni-ulm.de/course/view.php?id=9354}
		\end{tabular}
\end{frame}
...
\begin{frame}{Technical Matters -- Problems}
	...
	\bi
		...
		\bi
			...
			\item The judge accepts C(++), Java, Python3, Haskell, Lua, and x86 assembler
		\ei
...
\begin{frame}{Technical Matters -- GCPC}
	\bi
		\item The GCPC will take place on \\
				Saturday, June 16\textsuperscript{th}, 11:00-16:00.
...
\begin{frame}{Semester schedule}
	\begin{tabular}{l l}
			19.4. & Introduction I\\
			23.4. & Introduction II\\
			26.4. & Simple Algorithms \\
			03.5. & Datastructures \\
			07.5. & Problem Solving Paradigms \\
			17.5. & Greedy \\
			24.5. & Dynamic Programming I \\
			28.5. & Dynamic Programming II \\
			04.6. & Strings\\
			07.6. & Unweighted Graphs \\
