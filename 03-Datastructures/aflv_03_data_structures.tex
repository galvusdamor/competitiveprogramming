...
\subtitle{03 -- Data Structures}
%\newcommand{\shorttitle}{Data Structures -- May the fourth be with you!}
...
\begin{frame}{Today we're going to cover}
    \vspace{40pt}
    \bi
		\item Data structures and how to extend them
...
\item Maps \onslide<2->{- {\color{vhilight}map<int, int>}}
    ...
    \onslide<3->{
        ...
        \item Usually it's best to use the standard library implementations
                \bi
                    \item Almost definitly bug-free and fast
...
% row 1 column 1/.style={nodes={draw}}
    ...
    \end{tikzpicture}
    \bi
      \item $\mathrm{sum}(6) = $ \onslide<2->{\texttt{ft[6]}} \onslide<3->{$+$ \texttt{ft[4]}}
