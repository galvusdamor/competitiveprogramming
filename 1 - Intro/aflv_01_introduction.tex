...
%			\only<2>{\includegraphics[width = \textwidth]{images/team.jpg}}
%			\only<3>{\includegraphics[width = \textwidth]{images/wf.jpg}}
%			\only<4>{\includegraphics[width = 0.95\textwidth]{images/wc.jpg}}
%			\only<5>{\includegraphics[width = \textwidth]{images/bjarne.jpg}}
%		\end{center}
%\end{frame}
